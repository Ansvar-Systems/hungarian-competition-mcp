...
const TOOLS = [
    {
        ...
        description: "Full-text search across Bundeskartellamt enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and GVH articles cited.",
        inputSchema: {
            type: "object",
            properties: {
            ...
            switch (name) {
                ...
                case "hu_comp_about": {
                    return textContent({
                        name: SERVER_NAME,
                        version: pkgVersion,
                        description: "Bundeskartellamt (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the GVH (Gesetz gegen Wettbewerbsbeschränkungen).",
